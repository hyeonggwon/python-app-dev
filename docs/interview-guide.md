...
- `caps.design_arch_self` (기본 2) — architect-reviewer 자가 루프 (in-stage retry; backtrack 시 reset)
- `caps.design_revise` (기본 2) — design 사용자 revise (phase 내 누적; backtrack 에도 유지)
